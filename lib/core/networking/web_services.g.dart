...
class _WebServices implements WebServices {
  ...
  Future<LogoutResponseBody> logout() async {
    ...
    final _options = _setStreamType<LogoutResponseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'auth/logout',
  ...
  @override
  Future<AllapartmentResponseBody> getAllApartment() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<CreateApartmentResponseBody> createApartment({
    ...
    _data.fields.add(MapEntry('rooms', rooms.toString()));
    _data.fields.add(MapEntry('bathrooms', bathrooms.toString()));
    ...
    final _options = _setStreamType<CreateApartmentResponseBody>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateApartmentResponseBody _value;
    try {
      _value = CreateApartmentResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<FavoriteResponseBody> togglefavorite(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(favoriterequest.toJson());
  ...
  @override
  Future<FavResponseBody> getfavorite() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<FavResponseBody>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'favorites/get',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FavResponseBody _value;
    try {
      _value = FavResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<BookingResponseBody> bookapartment(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(bookingrequestbody.toJson());
    final _options = _setStreamType<BookingResponseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'reservations/make',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BookingResponseBody _value;
    try {
      _value = BookingResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<UserReservationsResponseBody> getAllUserReservations() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<CancelReservationResponseBody> cancelreservation(
    CancelReservationRequestBody cancerreservationrequestbody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(cancerreservationrequestbody.toJson());
    final _options = _setStreamType<CancelReservationResponseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'reservations/cancel',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CancelReservationResponseBody _value;
    try {
      _value = CancelReservationResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<OwnerReservationResponseBody> ownerreservations() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OwnerReservationResponseBody>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'owner/reservations',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OwnerReservationResponseBody _value;
    try {
      _value = OwnerReservationResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<ReservationNotificationResponseBody> handlingReservation(
    ...
    final _options = _setStreamType<ReservationNotificationResponseBody>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ReservationNotificationResponseBody _value;
    try {
      _value = ReservationNotificationResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
