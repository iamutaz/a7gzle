  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start, // أي نص جوا الكرت بيبدأ من اليسار
          children: [
          ...
          Padding(
           ...
           Padding(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween, // بيدفع السعر لليسار والقلب لليمين
                children: [
                  Text(
                    cardData.price, 
