...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _LogoutInitial<T> value)?  initial,TResult Function( LogoutLoading<T> value)?  logoutloading,TResult Function( LogoutSuccess<T> value)?  logoutuccess,TResult Function( LogoutFailure<T> value)?  logoutfailure,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogoutInitial() when initial != null:
return initial(_that);case LogoutLoading() when logoutloading != null:
return logoutloading(_that);case LogoutSuccess() when logoutuccess != null:
return logoutuccess(_that);case LogoutFailure() when logoutfailure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _LogoutInitial<T> value)  initial,required TResult Function( LogoutLoading<T> value)  logoutloading,required TResult Function( LogoutSuccess<T> value)  logoutuccess,required TResult Function( LogoutFailure<T> value)  logoutfailure,}){
final _that = this;
switch (_that) {
case _LogoutInitial():
return initial(_that);case LogoutLoading():
return logoutloading(_that);case LogoutSuccess():
return logoutuccess(_that);case LogoutFailure():
return logoutfailure(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LogoutInitial<T> value)?  initial,TResult? Function( LogoutLoading<T> value)?  logoutloading,TResult? Function( LogoutSuccess<T> value)?  logoutuccess,TResult? Function( LogoutFailure<T> value)?  logoutfailure,}){
final _that = this;
switch (_that) {
case _LogoutInitial() when initial != null:
return initial(_that);case LogoutLoading() when logoutloading != null:
...
@override
String toString() {
  return 'LogoutState<$T>.logoutuccess(data: $data)';
}
